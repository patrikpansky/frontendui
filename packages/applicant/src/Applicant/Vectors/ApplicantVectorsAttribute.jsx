...
/**
 * A component for displaying the `vectors` attribute of an applicant entity.
 *
 * This component checks if the `vectors` attribute exists on the `applicant` object. If `vectors` is undefined,
 ...
 *
 * @component
 * @param {Object} props - The props for the ApplicantVectorsAttribute component.
 * @param {Object} props.applicant - The object representing the applicant entity.
 * @param {Array} [props.applicant.vectors] - An array of vectors items associated with the applicant entity.
 ...
 * };
 *
 * <ApplicantVectorsAttribute applicant={applicantEntity} />
 */
export const ApplicantVectorsAttribute = ({applicant}) => {
    const { vectors } = applicant
...
query ApplicantQueryRead($id: id, $where: VectorInputFilter, $skip: Int, $limit: Int) {
...
export const ApplicantVectorsAttributeInifite = ({applicant}) => { 
    const {vectors} = applicant
