 ...
 * That must be manually inserted at PaymentInfoPageContent, usually this should be done 
 * as children of PaymentInfoLargeCard.
...
export const PaymentInfoPageNavbar = ({ paymentinfo, onSearchChange }) => {
    ...
    return (
        ...
        <MyNavbar onSearchChange={onSearchChange} >
            {paymentinfo && PaymentInfoPageSegments.map(({ segment, label }) => (
