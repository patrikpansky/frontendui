...
export const ProgramURI = `${URIRoot}/program/view/`;
 ...
 */
export const ProgramLink = ({program, ...props}) => {
    return <ProxyLink to={ProgramURI + program.id} {...props}>{program.name}</ProxyLink>
}