 ...
 * That must be manually inserted at ProgramPageContent, usually this should be done 
 * as children of ProgramLargeCard.
 * <ProgramLargeCard>
 *     <HashContainer>
 *         <VectorA id="history"/>
 *         <VectorB id="roles"/>
 ...
 */
export const ProgramPageNavbar = ({ program, children, onSearchChange }) => {
    const [currentHash, setHash] = useHash(); // Use the custom hook to manage hash
    
    return (
        <div className='screen-only'>
        <MyNavbar onSearchChange={onSearchChange} >
            {program && ProgramPageSegments.map(({ segment, label }) => (
