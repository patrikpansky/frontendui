...
/**
 * A component for displaying the `vectors` attribute of a state entity.
 *
 ...
 * @param {Array<Object>} [props.state.vectors] - An array of vector items associated with the state entity.
...
/**
 * Visualiser component for displaying a list of vector items using `StateVectorsAttribute`.
 *
 * Wraps the `StateVectorsAttribute` component, passing the given `items` as the `vectors` attribute
 ...
 * @param {...any} [props] - Additional props forwarded to `StateVectorsAttribute` (e.g., `filter`).
 *
...
const VectorsVisualiser = ({ items, ...props }) => 
    <StateVectorsAttribute {...props} state={{ vectors: items }} />

/**
 * Infinite-scrolling component for the `vectors` attribute of a state entity.
 *
 * Uses the generic `InfiniteScroll` component to fetch, merge, and display the `vectors` array
 * associated with the provided `state` object. It utilizes `VectorsVisualiser` for rendering,
 * and handles pagination, lazy-loading, and merging of items as the user scrolls.
 *
 * @component
 * @param {Object} props - Component props.
 * @param {Object} props.state - The state entity containing the `vectors` array.
 * @param {Array<Object>} [props.state.vectors] - (Optional) Preloaded vector items.
 ...
 * />
 */
export const StateVectorsAttributeInfinite = ({state, actionParams={}, ...props}) => { 
    const {vectors} = state
