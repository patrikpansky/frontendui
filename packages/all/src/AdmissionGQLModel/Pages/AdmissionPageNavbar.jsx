 ...
 * That must be manually inserted at AdmissionPageContent, usually this should be done 
 * as children of AdmissionLargeCard.
 * <AdmissionLargeCard>
 *     <HashContainer>
 *         <VectorA id="history"/>
 *         <VectorB id="roles"/>
...
export const AdmissionPageNavbar = ({ admission, onSearchChange }) => {
    ...
    return (
        ...
        <MyNavbar onSearchChange={onSearchChange} >
            {admission && AdmissionPageSegments.map(({ segment, label }) => (
