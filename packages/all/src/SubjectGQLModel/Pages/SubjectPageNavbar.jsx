 ...
 * That must be manually inserted at SubjectPageContent, usually this should be done 
 * as children of SubjectLargeCard.
 * <SubjectLargeCard>
 *     <HashContainer>
 *         <VectorA id="history"/>
 *         <VectorB id="roles"/>
...
export const SubjectPageNavbar = ({ subject, children, onSearchChange }) => {
    ...
    return (
        ...
        <MyNavbar onSearchChange={onSearchChange} >
            {subject && SubjectPageSegments.map(({ segment, label }) => (
