...
import { TemplateMediumContent } from "./TemplateMediumContent"
 ...
 * </TemplateMediumCard>
 */
export const TemplateMediumCard = ({template, children}) => {
    return (
        <TemplateCardCapsule title={<><PersonFill /> <TemplateLink template={template} /></>}>
            <TemplateMediumContent template={template}>
                {children}
