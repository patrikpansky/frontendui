...
const UserPageContentLazy = ({user}) => {
    ...
    const handleChange = async(e) => {
        // console.log("UserPageContentLazy.handleChange.e", e)
        const data = e.target.value
        const serverResponse = await delayer(() => fetch(data))
        // console.log("UserPageContentLazy.serverResponse", serverResponse)
    }
    const handleBlur = async(e) => {
        // console.log("UserPageContentLazy.handleBlur.e", e)
        const data = e.target.value
        const serverResponse = await delayer(() => fetch(data))
        // console.log("UserPageContentLazy.serverResponse", serverResponse)
    }
