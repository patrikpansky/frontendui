 ...
 * That must be manually inserted at GroupPageContent, usually this should be done 
 * as children of GroupLargeCard.
 * <GroupLargeCard>
 *     <HashContainer>
 *         <VectorA id="history"/>
 *         <VectorB id="roles"/>
...
export const GroupPageNavbar = ({ group, onSearchChange }) => {
    ...
    return (
        ...
        <MyNavbar onSearchChange={onSearchChange} >
            {group && GroupPageSegments.map(({ segment, label }) => (
