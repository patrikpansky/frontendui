 ...
 */
export const StateVectorsAttribute = ({state}) => {
    const { vectors } = state
...
query StateQueryRead($id: id, $where: VectorInputFilter, $skip: Int, $limit: Int) {
...
export const StateVectorsAttributeInifite = ({state}) => { 
    const {vectors} = state
