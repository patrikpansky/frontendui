 ...
 */
export const MembershipCUDButton = ({ operation, children, membership, onDone = () => {}, ...props }) => {
    ...
    const operationConfig = {
        C: {
            ...
            dialogTitle: "Vložit nové členství",
            loadingMsg: "Vkládám nové členství",
            renderContent: () => <MembershipMediumEditableContent membership={membership} />,
        },
        U: {
            // asyncAction: MembershipUpdateAsyncAction,
            dialogTitle: "Upravit členství",
            loadingMsg: "Ukládám členství",
            renderContent: () => <MembershipMediumEditableContent membership={membership} />,
        },
        D: {
            // asyncAction: MembershipDeleteAsyncAction,
            dialogTitle: "Chcete odebrat členství?",
            loadingMsg: "Odstraňuji členství",
            renderContent: () => (
                <h2>
                    {/* {membership?.name} ({membership?.nameEn}) */}
                </h2>
            ),
        },
    };
