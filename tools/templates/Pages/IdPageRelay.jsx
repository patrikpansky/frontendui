...
const {{Name name}}IdPageRelayQuery = graphql`
...
export const {{Name name}}IdPageRelay = () => {
    const { id } = useParams() || "837f62bd-ee81-4493-954d-51e8ef7ef025";
    const data = useLazyLoadQuery({{Name name}}IdPageRelayQuery, {id}, {fetchPolicy: 'store-and-network'});
