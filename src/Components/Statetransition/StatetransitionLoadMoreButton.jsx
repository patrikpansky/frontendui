...
export const StatetransitionLoadMoreButtonFragment = `
fragment StatetransitionLoadMoreButtonFragment on StatetransitionGQLModel {
        id
    }`

export const StatetransitionLoadMoreButton = ({ statetransitions, children }) => {
