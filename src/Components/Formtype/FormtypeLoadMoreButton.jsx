...
export const FormtypeLoadMoreButtonFragment = `
fragment FormtypeLoadMoreButtonFragment on FormtypeGQLModel {
        id
        forms { 
            id
            name
...
export const FormtypeLoadMoreButton = ({ formtypes, children }) => {
