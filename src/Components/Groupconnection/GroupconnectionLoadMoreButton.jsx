...
export const GroupconnectionLoadMoreButtonFragment = `
fragment GroupconnectionLoadMoreButtonFragment on GroupconnectionGQLModel {
        id
        edges { 
            cursor
        }
...
export const GroupconnectionLoadMoreButton = ({ groupconnections, children }) => {
