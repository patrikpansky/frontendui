...
export const ProjectcategoryLoadMoreButtonFragment = `
fragment ProjectcategoryLoadMoreButtonFragment on ProjectcategoryGQLModel {
        id
    }`

export const ProjectcategoryLoadMoreButton = ({ projectcategorys, children }) => {
