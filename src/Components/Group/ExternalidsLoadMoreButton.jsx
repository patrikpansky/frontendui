 ...
 * arguments
 */
export const GroupExternalidsQuery = `
query GroupExternalids($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const GroupExternalidsQueryAction = CreateAsyncActionFromQuery(GroupExternalidsQuery, {}, UpdateVectorAfterFetch("externalIds"))

export const GroupExternalidsLoadMoreButton = ({ group, limit=10, where, action=GroupExternalidsQueryAction, children }) => {
