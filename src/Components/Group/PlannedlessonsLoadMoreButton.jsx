 ...
 * arguments
 */
export const GroupPlannedlessonsQuery = `
query GroupPlannedlessons($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const GroupPlannedlessonsQueryAction = CreateAsyncActionFromQuery(GroupPlannedlessonsQuery, {}, UpdateVectorAfterFetch("plannedLessons"))

export const GroupPlannedlessonsLoadMoreButton = ({ group, limit=10, where, action=GroupPlannedlessonsQueryAction, children }) => {
