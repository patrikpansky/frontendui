 ...
 * where : 
 */
export const GroupEventsQuery = `
query GroupEvents($id: UUID!, $skip: Int, $limit: Int, $where: UGEventInputFilter) {
...
`
export const GroupEventsQueryAction = CreateAsyncActionFromQuery(GroupEventsQuery, {}, UpdateVectorAfterFetch("events"))

export const GroupEventsLoadMoreButton = ({ group, limit=10, where, action=GroupEventsQueryAction, children }) => {
