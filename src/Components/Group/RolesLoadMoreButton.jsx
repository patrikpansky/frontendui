 ...
 * where : 
 */
export const GroupRolesQuery = `
query GroupRoles($id: UUID!, $skip: Int, $limit: Int, $where: RoleInputWhereFilter) {
...
`
export const GroupRolesQueryAction = CreateAsyncActionFromQuery(GroupRolesQuery, {}, UpdateVectorAfterFetch("roles"))

export const GroupRolesLoadMoreButton = ({ group, limit=10, where, action=GroupRolesQueryAction, children }) => {
