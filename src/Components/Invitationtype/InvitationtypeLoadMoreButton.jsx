...
export const InvitationtypeLoadMoreButtonFragment = `
fragment InvitationtypeLoadMoreButtonFragment on InvitationtypeGQLModel {
        id
    }`

export const InvitationtypeLoadMoreButton = ({ invitationtypes, children }) => {
