...
export const QuestionvalueLoadMoreButtonFragment = `
fragment QuestionvalueLoadMoreButtonFragment on QuestionvalueGQLModel {
        id
    }`

export const QuestionvalueLoadMoreButton = ({ questionvalues, children }) => {
