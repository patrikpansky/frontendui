 ...
 * where : 
 */
export const StatemachineTransitionsQuery = `
query StatemachineTransitions($id: UUID!, $skip: Int, $limit: Int, $where: StateTransitionWhereFilter) {
...
`
export const StatemachineTransitionsQueryAction = CreateAsyncActionFromQuery(StatemachineTransitionsQuery, {}, UpdateVectorAfterFetch("transitions"))

export const StatemachineTransitionsLoadMoreButton = ({ statemachine, limit=10, where, action=StatemachineTransitionsQueryAction, children }) => {
