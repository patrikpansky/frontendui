 ...
 * arguments
 */
export const ProjectFinancesQuery = `
query ProjectFinances($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const ProjectFinancesQueryAction = CreateAsyncActionFromQuery(ProjectFinancesQuery, {}, UpdateVectorAfterFetch("finances"))

export const ProjectFinancesLoadMoreButton = ({ project, limit=10, where, action=ProjectFinancesQueryAction, children }) => {
