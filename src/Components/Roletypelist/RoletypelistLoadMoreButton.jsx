...
export const RoletypelistLoadMoreButtonFragment = `
fragment RoletypelistLoadMoreButtonFragment on RoletypelistGQLModel {
        id
        roletypes { 
            id
            created
...
export const RoletypelistLoadMoreButton = ({ roletypelists, children }) => {
