 ...
 * arguments
 */
export const FacilityExternalidsQuery = `
query FacilityExternalids($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const FacilityExternalidsQueryAction = CreateAsyncActionFromQuery(FacilityExternalidsQuery, {}, UpdateVectorAfterFetch("externalIds"))

export const FacilityExternalidsLoadMoreButton = ({ facility, limit=10, where, action=FacilityExternalidsQueryAction, children }) => {
