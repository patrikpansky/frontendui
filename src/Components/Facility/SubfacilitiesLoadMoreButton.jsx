 ...
 * arguments
 */
export const FacilitySubfacilitiesQuery = `
query FacilitySubfacilities($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const FacilitySubfacilitiesQueryAction = CreateAsyncActionFromQuery(FacilitySubfacilitiesQuery, {}, UpdateVectorAfterFetch("subFacilities"))

export const FacilitySubfacilitiesLoadMoreButton = ({ facility, limit=10, where, action=FacilitySubfacilitiesQueryAction, children }) => {
