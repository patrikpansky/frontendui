 ...
 * access : 
 */
export const StateRoletypesQuery = `
query StateRoletypes($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const StateRoletypesQueryAction = CreateAsyncActionFromQuery(StateRoletypesQuery, {}, UpdateVectorAfterFetch("roletypes"))

export const StateRoletypesLoadMoreButton = ({ state, limit=10, where, action=StateRoletypesQueryAction, children }) => {
