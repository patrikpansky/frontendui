 ...
 * where : 
 */
export const StateTargetsQuery = `
query StateTargets($id: UUID!, $skip: Int, $limit: Int, $where: StateTransitionWhereFilter) {
...
`
export const StateTargetsQueryAction = CreateAsyncActionFromQuery(StateTargetsQuery, {}, UpdateVectorAfterFetch("targets"))

export const StateTargetsLoadMoreButton = ({ state, limit=10, where, action=StateTargetsQueryAction, children }) => {
