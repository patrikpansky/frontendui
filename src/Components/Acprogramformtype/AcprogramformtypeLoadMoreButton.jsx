...
export const AcprogramformtypeLoadMoreButtonFragment = `
fragment AcprogramformtypeLoadMoreButtonFragment on AcprogramformtypeGQLModel {
        id
    }`

export const AcprogramformtypeLoadMoreButton = ({ acprogramformtypes, children }) => {
    ...
    if (acprogramformtypes.length === 0) {
        return (
