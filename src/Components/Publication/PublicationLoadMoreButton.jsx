...
export const PublicationLoadMoreButtonFragment = `
fragment PublicationLoadMoreButtonFragment on PublicationGQLModel {
        id
        authors { 
            id
            name
...
export const PublicationLoadMoreButton = ({ publications, children }) => {
