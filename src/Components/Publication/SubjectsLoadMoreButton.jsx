 ...
 * returns List[AcSubjectGQLModel]
 *  : 
 * arguments
 */
export const PublicationSubjectsQuery = `
query PublicationSubjects($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const PublicationSubjectsQueryAction = CreateAsyncActionFromQuery(PublicationSubjectsQuery, {}, UpdateVectorAfterFetch("subjects"))

export const PublicationSubjectsLoadMoreButton = ({ publication, limit=10, where, action=PublicationSubjectsQueryAction, children }) => {
