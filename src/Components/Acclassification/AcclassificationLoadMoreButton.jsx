...
export const AcclassificationLoadMoreButtonFragment = `
fragment AcclassificationLoadMoreButtonFragment on AcclassificationGQLModel {
        id
    }`

export const AcclassificationLoadMoreButton = ({ acclassifications, children }) => {
