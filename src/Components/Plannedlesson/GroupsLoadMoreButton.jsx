 ...
 * arguments
 */
export const PlannedlessonGroupsQuery = `
query PlannedlessonGroups($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const PlannedlessonGroupsQueryAction = CreateAsyncActionFromQuery(PlannedlessonGroupsQuery, {}, UpdateVectorAfterFetch("groups"))

export const PlannedlessonGroupsLoadMoreButton = ({ plannedlesson, limit=10, where, action=PlannedlessonGroupsQueryAction, children }) => {
