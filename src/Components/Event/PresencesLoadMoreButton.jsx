 ...
 * desc : 
 */
export const EventPresencesQuery = `
query EventPresences($id: UUID!, $skip: Int, $limit: Int, $where: PresenceInputFilter) {
...
`
export const EventPresencesQueryAction = CreateAsyncActionFromQuery(EventPresencesQuery, {}, UpdateVectorAfterFetch("presences"))

export const EventPresencesLoadMoreButton = ({ event, limit=10, where, action=EventPresencesQueryAction, children }) => {
