 ...
 * arguments
 */
export const EventGroupsQuery = `
query EventGroups($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const EventGroupsQueryAction = CreateAsyncActionFromQuery(EventGroupsQuery, {}, UpdateVectorAfterFetch("groups"))

export const EventGroupsLoadMoreButton = ({ event, limit=10, where, action=EventGroupsQueryAction, children }) => {
