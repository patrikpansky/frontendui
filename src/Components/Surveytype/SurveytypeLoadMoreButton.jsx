...
export const SurveytypeLoadMoreButtonFragment = `
fragment SurveytypeLoadMoreButtonFragment on SurveytypeGQLModel {
        id
    }`

export const SurveytypeLoadMoreButton = ({ surveytypes, children }) => {
