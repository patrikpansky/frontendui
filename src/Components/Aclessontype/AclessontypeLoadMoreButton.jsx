...
export const AclessontypeLoadMoreButtonFragment = `
fragment AclessontypeLoadMoreButtonFragment on AclessontypeGQLModel {
        id
    }`

export const AclessontypeLoadMoreButton = ({ aclessontypes, children }) => {
