...
export const UserconnectionLoadMoreButtonFragment = `
fragment UserconnectionLoadMoreButtonFragment on UserconnectionGQLModel {
        id
        edges { 
            cursor
        }
...
export const UserconnectionLoadMoreButton = ({ userconnections, children }) => {
