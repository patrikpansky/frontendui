 ...
 * returns List[AcSemesterGQLModel]
 *  : 
 * arguments
 */
export const AcsubjectSemestersQuery = `
query AcsubjectSemesters($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const AcsubjectSemestersQueryAction = CreateAsyncActionFromQuery(AcsubjectSemestersQuery, {}, UpdateVectorAfterFetch("semesters"))

export const AcsubjectSemestersLoadMoreButton = ({ acsubject, limit=10, where, action=AcsubjectSemestersQueryAction, children }) => {
