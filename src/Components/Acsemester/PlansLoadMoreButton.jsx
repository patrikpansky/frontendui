 ...
 * Acsemester.plans
 * Plans
 * returns List[PlanGQLModel]
 *  : 
 * arguments
 */
export const AcsemesterPlansQuery = `
query AcsemesterPlans($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const AcsemesterPlansQueryAction = CreateAsyncActionFromQuery(AcsemesterPlansQuery, {}, UpdateVectorAfterFetch("plans"))

export const AcsemesterPlansLoadMoreButton = ({ acsemester, limit=10, where, action=AcsemesterPlansQueryAction, children }) => {
