 ...
 * Acsemester.topics
 * topics
 * returns List[AcTopicGQLModel]
 *  : 
 * arguments
 */
export const AcsemesterTopicsQuery = `
query AcsemesterTopics($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const AcsemesterTopicsQueryAction = CreateAsyncActionFromQuery(AcsemesterTopicsQuery, {}, UpdateVectorAfterFetch("topics"))

export const AcsemesterTopicsLoadMoreButton = ({ acsemester, limit=10, where, action=AcsemesterTopicsQueryAction, children }) => {
