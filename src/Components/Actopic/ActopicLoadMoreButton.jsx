...
export const ActopicLoadMoreButtonFragment = `
fragment ActopicLoadMoreButtonFragment on ActopicGQLModel {
        id
        lessons { 
            id
            name
...
export const ActopicLoadMoreButton = ({ actopics, children }) => {
