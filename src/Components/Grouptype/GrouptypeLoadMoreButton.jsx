...
export const GrouptypeLoadMoreButtonFragment = `
fragment GrouptypeLoadMoreButtonFragment on GrouptypeGQLModel {
        id
    }`

export const GrouptypeLoadMoreButton = ({ grouptypes, children }) => {
