...
export const PresenceLoadMoreButtonFragment = `
fragment PresenceLoadMoreButtonFragment on PresenceGQLModel {
        id
    }`

export const PresenceLoadMoreButton = ({ presences, children }) => {
