...
export const FinancecategoryLoadMoreButtonFragment = `
fragment FinancecategoryLoadMoreButtonFragment on FinancecategoryGQLModel {
        id
    }`

export const FinancecategoryLoadMoreButton = ({ financecategorys, children }) => {
