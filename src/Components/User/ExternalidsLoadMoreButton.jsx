 ...
 * arguments
 */
export const UserExternalidsQuery = `
query UserExternalids($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const UserExternalidsQueryAction = CreateAsyncActionFromQuery(UserExternalidsQuery, {}, UpdateVectorAfterFetch("externalIds"))

export const UserExternalidsLoadMoreButton = ({ user, limit=10, where, action=UserExternalidsQueryAction, children }) => {
