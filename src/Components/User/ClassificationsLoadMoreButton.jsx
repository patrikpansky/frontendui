 ...
 * arguments
 */
export const UserClassificationsQuery = `
query UserClassifications($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const UserClassificationsQueryAction = CreateAsyncActionFromQuery(UserClassificationsQuery, {}, UpdateVectorAfterFetch("classifications"))

export const UserClassificationsLoadMoreButton = ({ user, limit=10, where, action=UserClassificationsQueryAction, children }) => {
