 ...
 * arguments
 */
export const UserAuthorpublicationsQuery = `
query UserAuthorpublications($id: UUID!, $skip: Int, $limit: Int, $where: ) {
    result: userById(id: $id) {
        id
        authorPublications(skip: $skip, limit: $limit, where: $where) {
            __typename
            id
            name
            lastchange
...
`
export const UserAuthorpublicationsQueryAction = CreateAsyncActionFromQuery(UserAuthorpublicationsQuery, {}, UpdateVectorAfterFetch("authorPublications"))

export const UserAuthorpublicationsLoadMoreButton = ({ user, limit=10, where, action=UserAuthorpublicationsQueryAction, children }) => {
