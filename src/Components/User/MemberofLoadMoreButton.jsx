 ...
 * grouptypeId : 
 */
export const UserMemberofQuery = `
query UserMemberof($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const UserMemberofQueryAction = CreateAsyncActionFromQuery(UserMemberofQuery, {}, UpdateVectorAfterFetch("memberOf"))

export const UserMemberofLoadMoreButton = ({ user, limit=10, where, action=UserMemberofQueryAction, children }) => {
