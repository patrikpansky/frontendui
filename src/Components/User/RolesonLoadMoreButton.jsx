...
/**
 * User.rolesOn
 * active roles to this user
 * returns List[RoleGQLModel]
 *  : 
 * arguments
 */
export const UserRolesonQuery = `
query UserRoleson($id: UUID!, $skip: Int, $limit: Int, $where: ) {
    result: userById(id: $id) {
        id
        rolesOn(skip: $skip, limit: $limit, where: $where) {
            __typename
            id
            created
            lastchange
...
`
export const UserRolesonQueryAction = CreateAsyncActionFromQuery(UserRolesonQuery, {}, UpdateVectorAfterFetch("rolesOn"))

export const UserRolesonLoadMoreButton = ({ user, limit=10, where, action=UserRolesonQueryAction, children }) => {
