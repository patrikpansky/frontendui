 ...
 * arguments
 */
export const UserPlannedlessonsQuery = `
query UserPlannedlessons($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const UserPlannedlessonsQueryAction = CreateAsyncActionFromQuery(UserPlannedlessonsQuery, {}, UpdateVectorAfterFetch("plannedLessons"))

export const UserPlannedlessonsLoadMoreButton = ({ user, limit=10, where, action=UserPlannedlessonsQueryAction, children }) => {
