 ...
 * returns List[MembershipGQLModel]
 * where : MembershipInputWhereFilter
 * arguments
 * skip : 
 * limit : 
 * orderby : 
 * where : 
 */
export const UserMembershipQuery = `
query UserMembership($id: UUID!, $skip: Int, $limit: Int, $where: MembershipInputWhereFilter) {
    result: userById(id: $id) {
        id
        membership(skip: $skip, limit: $limit, where: $where) {
            __typename
            id
            created
            lastchange
...
`
export const UserMembershipQueryAction = CreateAsyncActionFromQuery(UserMembershipQuery, {}, UpdateVectorAfterFetch("membership"))

export const UserMembershipLoadMoreButton = ({ user, limit=10, where, action=UserMembershipQueryAction, children }) => {
