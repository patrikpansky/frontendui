 ...
 * arguments
 */
export const UserStudiesQuery = `
query UserStudies($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const UserStudiesQueryAction = CreateAsyncActionFromQuery(UserStudiesQuery, {}, UpdateVectorAfterFetch("studies"))

export const UserStudiesLoadMoreButton = ({ user, limit=10, where, action=UserStudiesQueryAction, children }) => {
