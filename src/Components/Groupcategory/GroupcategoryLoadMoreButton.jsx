...
export const GroupcategoryLoadMoreButtonFragment = `
fragment GroupcategoryLoadMoreButtonFragment on GroupcategoryGQLModel {
        id
        types { 
            id
            created
...
export const GroupcategoryLoadMoreButton = ({ groupcategorys, children }) => {
