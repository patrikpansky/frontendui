...
export const QuestiontypeLoadMoreButtonFragment = `
fragment QuestiontypeLoadMoreButtonFragment on QuestiontypeGQLModel {
        id
    }`

export const QuestiontypeLoadMoreButton = ({ questiontypes, children }) => {
