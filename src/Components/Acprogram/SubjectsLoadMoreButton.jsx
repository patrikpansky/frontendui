 ...
 * arguments
 */
export const AcprogramSubjectsQuery = `
query AcprogramSubjects($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const AcprogramSubjectsQueryAction = CreateAsyncActionFromQuery(AcprogramSubjectsQuery, {}, UpdateVectorAfterFetch("subjects"))

export const AcprogramSubjectsLoadMoreButton = ({ acprogram, limit=10, where, action=AcprogramSubjectsQueryAction, children }) => {
