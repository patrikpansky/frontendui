...
export const FormitemtypeLoadMoreButtonFragment = `
fragment FormitemtypeLoadMoreButtonFragment on FormitemtypeGQLModel {
        id
    }`

export const FormitemtypeLoadMoreButton = ({ formitemtypes, children }) => {
