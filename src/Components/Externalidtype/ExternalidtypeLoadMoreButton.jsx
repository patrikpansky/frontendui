...
export const ExternalidtypeLoadMoreButtonFragment = `
fragment ExternalidtypeLoadMoreButtonFragment on ExternalidtypeGQLModel {
        id
    }`

export const ExternalidtypeLoadMoreButton = ({ externalidtypes, children }) => {
