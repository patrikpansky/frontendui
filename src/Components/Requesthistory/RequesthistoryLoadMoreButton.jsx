...
export const RequesthistoryLoadMoreButtonFragment = `
fragment RequesthistoryLoadMoreButtonFragment on RequesthistoryGQLModel {
        id
    }`

export const RequesthistoryLoadMoreButton = ({ requesthistorys, children }) => {
