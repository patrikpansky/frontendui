...
export const PresencetypeLoadMoreButtonFragment = `
fragment PresencetypeLoadMoreButtonFragment on PresencetypeGQLModel {
        id
    }`

export const PresencetypeLoadMoreButton = ({ presencetypes, children }) => {
