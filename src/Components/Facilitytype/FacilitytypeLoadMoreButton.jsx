...
export const FacilitytypeLoadMoreButtonFragment = `
fragment FacilitytypeLoadMoreButtonFragment on FacilitytypeGQLModel {
        id
    }`

export const FacilitytypeLoadMoreButton = ({ facilitytypes, children }) => {
