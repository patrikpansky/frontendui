 ...
 * arguments
 */
export const MilestonePreviousQuery = `
query MilestonePrevious($id: UUID!, $skip: Int, $limit: Int, $where: ) {
...
`
export const MilestonePreviousQueryAction = CreateAsyncActionFromQuery(MilestonePreviousQuery, {}, UpdateVectorAfterFetch("previous"))

export const MilestonePreviousLoadMoreButton = ({ milestone, limit=10, where, action=MilestonePreviousQueryAction, children }) => {
