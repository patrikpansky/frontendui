...
export const EventtypeLoadMoreButtonFragment = `
fragment EventtypeLoadMoreButtonFragment on EventtypeGQLModel {
        id
    }`

export const EventtypeLoadMoreButton = ({ eventtypes, children }) => {
