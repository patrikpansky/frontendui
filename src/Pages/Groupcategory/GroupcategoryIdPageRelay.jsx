...
const GroupcategoryIdPageRelayQuery = graphql`
...
export const GroupcategoryIdPageRelay = () => {
    const { id } = useParams() || "837f62bd-ee81-4493-954d-51e8ef7ef025";
    const data = useLazyLoadQuery(GroupcategoryIdPageRelayQuery, {id}, {fetchPolicy: 'store-and-network'});
