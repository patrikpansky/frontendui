...
import { useFreshItem, CreateAsyncActionFromQuery, createLazyComponent, useDispatch } from "@hrbolek/uoisfrontend-shared/src"
...
const UserLazyEventCard = createLazyComponentWithLazyLoading(UserEventsCard2, "user", UserEventsAsyncActionRead)
/**
 ...
 */
const UserPageContentLazy = createLazyComponentWithLazyLoading(UserPageContent, "user", UserAsyncActionRead);
