...
const StatemachineIdPageRelayQuery = graphql`
...
export const StatemachineIdPageRelay = () => {
    const { id } = useParams() || "837f62bd-ee81-4493-954d-51e8ef7ef025";
    const data = useLazyLoadQuery(StatemachineIdPageRelayQuery, {id}, {fetchPolicy: 'store-and-network'});
